...
export default function HomeSecondSection({ title, redTitle, para, smallImg, bigImg }) {
      ...
      <div className="mx-auto px-20 py-12 sm:py-16 flex flex-col md:flex-row items-center justify-around sm:gap-10 max-w-8xl">
        ...
        <div className="w-full md:w-2/5 text-center md:text-left px-2 sm:px-4">
          <h1 className="text-3xl sm:text-3xl md:text-5xl font-bold text-gray-800 mb-4 leading-snug">
            {title} <span className="text-red-600">{redTitle}</span>
          </h1>
        ...
        <div className="w-full md:w-1/2 relative flex justify-center md:justify-end px-2 sm:px-0">
          ...
          <div className="absolute -bottom-16 sm:-bottom-20 left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-5 w-[150px] h-[150px] sm:w-[200px] sm:h-[300px] md:w-[250px] md:h-[350px] lg:w-[300px] lg:h-[450px]">
            <img
              ...
              className="object-cover border-[8px] sm:border-[12px] border-white shadow-2xl w-full h-full"
